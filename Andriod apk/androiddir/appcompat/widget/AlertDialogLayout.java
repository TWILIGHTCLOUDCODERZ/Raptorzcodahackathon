...
public class AlertDialogLayout extends C0379j0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: q */
    public static int m90q(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m90q(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    public void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L_0x0050:
            ...
            b.b.h.j0$a r6 = (p009b.p017b.p026h.C0379j0.C0380a) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L_0x0073
            r7 = r2
        L_0x0073:
            java.util.concurrent.atomic.AtomicInteger r8 = p009b.p086k.p098j.C1496p.f4584a
                ...
                if (mode2 != 1073741824) {
                    ...
                    for (int i13 = 0; i13 < childCount; i13++) {
                        ...
                        if (childAt3.getVisibility() != 8) {
                            C0379j0.C0380a aVar = (C0379j0.C0380a) childAt3.getLayoutParams();
                            if (aVar.width == -1) {
                                int i14 = aVar.height;
